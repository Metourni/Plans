...
namespace Metourni\Plans\Models;
...
class PlanSubscriptionModel extends Model
{
    ...
    public function consumeFeature(string $featureCode, float $amount)
    {
        ...
        event(new \Metourni\Plans\Events\FeatureConsumed($this, $feature, $amount, $remaining));
    ...
    public function unconsumeFeature(string $featureCode, float $amount)
    {
        ...
        event(new \Metourni\Plans\Events\FeatureUnconsumed($this, $feature, $amount, $remaining));
